...
public class ImageController {
    ...
    public ResponseEntity<MyResponse> uploadImageToApartment(@RequestParam("files") List<MultipartFile> files,
        ...
        for (int i = 0; i < files.size(); i++) {
            var image = Image.builder()
                    ...
                    .src("data:" + files.get(i).getContentType() + ";base64," + Base64.getEncoder().encodeToString(files.get(i).getBytes()))
                    .build();
            images.add(image);
        }
